...
import com.epam.auto.test.level1.claasses.univercities.Group;
import com.epam.auto.test.level1.claasses.univercities.Student;
import com.epam.auto.test.level1.claasses.univercities.University;
...
public class Task_05_JavaExcept {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.printf("Average mark for 'Law' subject, 'Customs' group, FTUG: %.2f\n",
					universityBNTU.getSubjectAverageMarkByGroup("FTUG", "Customs", Subject.LAW));
			System.out.printf("Average mark for 'Math' subject: %.2f\n", universityBNTU.getSubjectAverageMark(Subject.MATH));
		} catch (InvalidDataException e) {
			System.err.println(e.getMessage() + e.getResult());
		}
	}
}